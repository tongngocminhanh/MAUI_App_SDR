...
* Only button *Choose a text file* is available for clicking, because none of the needed parameters are defined. After inserting 7 over 8 parameters, all button works. 
