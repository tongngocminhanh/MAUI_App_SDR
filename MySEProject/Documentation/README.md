...
For detailed instructions on how to install and use the app, please check [User Manual](./User%20Manual.md).

Each function in the project has a strong bond with one another; therefore, no Unit Test project was included in this project. All test cases were taken by running the app, and manually selecting inputs as [User Manual](./User%20Manual.md). For testing, multiple cases are considered. The project compared the results generated by *AppSDR* with *draw_figure.py*. 
